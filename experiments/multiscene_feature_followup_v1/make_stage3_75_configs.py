...
REPO = HERE.parents[1]
MANIFEST = HERE / "stage3_75_manifest.yaml"
OUT = HERE / "stage3_75_configs"
INDEX = HERE / "stage3_75_arms.json"
QUEUE = HERE / "stage3_75_queue.txt"
...
def main() -> int:
    ...
    random.Random("stage3-75:seed45").shuffle(remainder)
